...
public:
	...
	virtual void updateGraphObj(int shapeindex ,int objIndex ,const float* position, const float* quaternion, const float* color, const float* scaling);
	...
	virtual void updateCamera(float projectionMatrix[16] ,float viewMatrix[16]);
