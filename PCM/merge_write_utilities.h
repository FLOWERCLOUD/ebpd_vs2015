...
static void depthToCloud(char* file_in, char* file_out)
{
...
static void getDifferentLabelPoints( char* _beforeFileName , char* _afterFileName , char* outFileName)
{
...
static void mergeFile(char* CORR_FILESNAME ,char* CORR_FILEOUT_NAME , char* LABEL_FILESNAME , char* LABEL_FILEOUT_NAME)
{
...
static void appendcorr( const char* file_in ,char* file_out)
{
	FILE* in_file = fopen( file_in,"r");
...
static void appendlabel( const char* file_in ,char* file_out)
{
	FILE* in_file = fopen( file_in,"r");
	FILE* outfile = fopen( file_out,"a");
	//	ofstream fout(file_out);
...
static ScalarType corrColormap[19][3] = {  
...
static void writePlyFromPly(char* _plyfilename , char* _outplyfilename , ScalarType** colormap)
{
