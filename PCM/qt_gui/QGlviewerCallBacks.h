#ifndef _QGLVIEWERCALLBACKS_H_
#define _QGLVIEWERCALLBACKS_H_
#include "QGLViewer/qglviewer.h"
#include "bullet/BulletOpenGLApplication.h"
...
int qglviwerRegister(QGLViewer* qgl, BulletOpenGLApplication* pApp) {
