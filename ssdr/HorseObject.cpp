...
bool HorseObject::OnInit(ID3D11Device* device, ID3D11DeviceContext* deviceContext, const UINT width, const UINT height)
{
	...
	std::string reference_filename = "./data/keg/keg1.obj";
	std::string animation_filename = "./data/keg/keg%01d.obj";

	std::wstring w_reference_filename;
	std::wstring w_animation_filename;
	StringToWString( reference_filename,w_reference_filename);
	StringToWString( animation_filename,w_animation_filename);
    //LoadModel(device, L"./data/horse-gallop/horse-gallop-reference.obj", XMFLOAT4A(0.5f, 0.5f, 0.5f, 1.0f));
    //LoadAnim(L"./data/horse-gallop/horse-gallop-%02d.obj");
	LoadModel(device,w_reference_filename.c_str(),XMFLOAT4A(0.5f, 0.5f, 0.5f, 1.0f));
	LoadAnim(w_animation_filename.c_str());
	//LoadModel(device, L"./data/lion-poses/lion-reference.obj", XMFLOAT4A(0.5f, 0.5f, 0.5f, 1.0f));
	//LoadAnim(L"./data/lion-poses/lion-%02d.obj");
	//LoadModel(device, L"./data/keg/keg1.obj", XMFLOAT4A(0.5f, 0.5f, 0.5f, 1.0f));
	//LoadAnim(L"./data/keg/keg%01d.obj");
	//LoadModel(device, L"./data/horse-poses/horse-01.obj", XMFLOAT4A(0.5f, 0.5f, 0.5f, 1.0f));
	//LoadAnim(L"./data/horse-poses/horse-%02d.obj");
...
//	GetRigFromFile(ssdrOut ,"./horse_skinning.txt");

    double errorsq = SSDR::Decompose(ssdrOut, ssdrIn, ssdrParam);
	std::cout<<"error square : "<<errorsq<<std::endl;
	SSDR::WriteRigToFile(ssdrOut ,ssdrIn,ssdrParam,"./data/keg/keg_skinning.rig");
	SSDR::WriteRigToFileFormat2(ssdrOut ,ssdrIn,ssdrParam,this,"./data/keg/","keg_skinning");
	//SSDR::WriteRigToFile(ssdrOut ,ssdrIn,ssdrParam,"./data/lion_skinning.txt");
	//SSDR::WriteRigToFileFormat2(ssdrOut ,ssdrIn,ssdrParam,this,"./data/","lion_skinning");
